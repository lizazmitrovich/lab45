...
public class ImageMusicFragment extends Fragment {
    ...
    public void SaveData(){
        ...
        if(result){
            ...
            Toast.makeText(getActivity(), "Не успешно", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void OpenData(){
        ...
        if(content!=null){
            ...
            Toast.makeText(getActivity().getApplicationContext(), "Не удалось открыть", Toast.LENGTH_LONG).show();
        }
    }
}