...
public class JSONWriterReader {
    ...
    public static ArrayList<Post> importFromJSON(Context context) {
        ...
        try{
            ...
            Data dataItems = gson.fromJson(jsonString.toString(), Data.class);
            System.out.println(gson.fromJson(jsonString.toString(), Data.class));
    ...
    public static boolean exportToJSON(Context context, ArrayList<Post> dataList) {
        ...
        Gson gson = new Gson();//для сериализ-и в формат
        Data dataItems = new Data();
